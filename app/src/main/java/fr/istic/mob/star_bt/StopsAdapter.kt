...
class StopsAdapter(private val context: Context, private val myObjects: List<stops>, private val date: String, private val heure: String, private val ligne: String, private val direction: String) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textView3.text = current.wheelchair
        if (current.wheelchair == "0" || current.wheelchair == ""){
            holder.textView3.text = "Pas d'information disponible"
        } else if(current.wheelchair == "1"){
            holder.textView3.text = "Accessible aux fauteuils roulants"
        } else{
            holder.textView3.text = "Pas accessible aux fauteuils roulants"
        }
